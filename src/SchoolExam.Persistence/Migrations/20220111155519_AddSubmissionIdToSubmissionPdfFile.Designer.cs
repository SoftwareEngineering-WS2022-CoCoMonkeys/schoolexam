...
namespace SchoolExam.Persistence.Migrations
{
    ...
    [Migration("20220111155519_AddSubmissionIdToSubmissionPdfFile")]
    partial class AddSubmissionIdToSubmissionPdfFile
    {
            ...
            modelBuilder.Entity("SchoolExam.Domain.Entities.ExamAggregate.Exam", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Description = "Mündliche Leistungsfeststellung",
            ...
            modelBuilder.Entity("SchoolExam.Domain.Entities.ExamAggregate.ExamBooklet", b =>
                {
                    ...
                    b.HasOne("SchoolExam.Domain.Entities.SubmissionAggregate.Submission", "Submission")
                        .WithMany()
            ...
            modelBuilder.Entity("SchoolExam.Domain.Entities.ExamAggregate.ExamTask", b =>
                {
                    ...
                    b.OwnsOne("SchoolExam.Domain.ValueObjects.ExamPosition", "Position", b1 =>
                        {
