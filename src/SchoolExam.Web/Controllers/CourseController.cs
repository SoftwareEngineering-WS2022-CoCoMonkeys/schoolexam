...
public class CourseController : ApiController<CourseController>
{
    ...
    {
        await _courseService.Create(GetPersonId()!.Value, courseWriteModel.Name, courseWriteModel.Topic);
        return Ok();
    }
    ...
    {
        await _courseService.Update(courseId, courseWriteModel.Name, courseWriteModel.Topic);
        return Ok();
    }
